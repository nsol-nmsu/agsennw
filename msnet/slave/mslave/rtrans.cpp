...
void rt_state::rt_fsm_event(uint8_t type, const void *data){
        ...
        switch(type){
                case RTRANS_TYPE_ACK: {
                        ...
                        /*Serial.println("\n ACK Remove from transmit queue");//TODO
                        Serial.flush();*/
                ...
                case RTRANS_TYPE_NAK: {
                       ...
                       /* Serial.println("\n NAK Remove from transmit queue");//TODO
                        Serial.flush();*/
                        break;
                }
        }
...
void rt_state::rt_tx_queued(){
        ...
        rb_peek(&this->tx_queue, &pkt[0], sizeof(rt_out_header) + hdr->len + 1);
        //rb_peek(&this->tx_queue, &pkt[0], sizeof(rt_out_header));
...
rt_state::rt_state(SoftwareSerial &xs, rt_callback cb_func){
        ...
        rb_init(&this->rx_queue, rtrans_rx_buffer, RTRANS_ABBREV_BUFFER);
}
...
void rt_state::rt_init(){
        ...
        //TODO: Uncomment; I commented out address change code
